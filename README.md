...
- [`multispeak/accent-synthetic-voices`](https://huggingface.co/datasets/multispeak/accent-synthetic-voices) — **public**; 30 ElevenLabs voices across domains (`hiring`, `presentation`; `english-test` coming), tagged by a `domain` column. Also regenerable via `python models/run_elevenlabs.py`.
